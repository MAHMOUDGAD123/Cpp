...
// Solution 2 ( avoid removing the 0 at the number ends )
...
int main()
{
	...
	if (Is_Palindrome_Number(Number))
		cout << "Yes, it is a palonddrome number." << endl;
	else
		cout << "No, it is not a palonddrome number." << endl;*/


	// Solution 2

	string Number = Read_String_Positive_Int_Number("Please, Enter A Positive Integer Number?");
