...
unsigned int Read_Positive_Int_NumberInRange(string Message, int from, int to)
{
	string N;
	do
	{
...
void Read_IntArray(short Array[], short& Arr_Length)
{
	...
	Arr_Length = Read_Positive_Int_NumberInRange("Please, Enter The Array Length?", 1, 100);
...
{
	Arr_Length = Read_Positive_Int_Number("Please, Enter The Array Length?");

	short N = Read_Positive_Int_Number("Enter The Range Of The Array Element?");
...
{
	short X = 0;
	short N = Read_Positive_Int_Number("Enter The Range Of The Array Element? (No Repeating)");
...
//*******************************************************************************************************************************************************
//*******************************************************************************************************************************************************
// Copy Array Odd Numbers Using _AddElementToArray_ 

void _Fill_Array_With_Random_Numbers_From1toN(short Array[], short Arr_Length)
{
	short N = Read_Positive_Int_Number("Enter The Range Of The Array Element?");
...
void _Add_ElementToArray(short Number, short Array[], short& Arr_Length)
{
	// To Add An Element To An Array & Increase Length By 1
...
int main()
{
	...
	short Source_Array[100], CopyOdd_Array[100], CopyEven_Array[100];
	short Source_Length = 0, CopyOdd_Length = 0, CopyEven_Length = 0;

	Source_Length = Read_Positive_Int_Number("Please, Enter The Length Of The Original Array?");

	Fill_Array_With_Random_Numbers_From1toN(Source_Array, Source_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Original Array Elements: {  ";
	Print_Array(Source_Array, Source_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;

	CopyArray_OddNumbersBy_AddElementToArray(Source_Array, CopyOdd_Array, Source_Length, CopyOdd_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Copy Array Of Odd Numbers: {  ";
	Print_Array(CopyOdd_Array, CopyOdd_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;

	CopyArray_EvenNumbersBy_AddElementToArray(Source_Array, CopyEven_Array, Source_Length, CopyEven_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Copy Array Of Even Numbers: {  ";
	Print_Array(CopyEven_Array, CopyEven_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;
