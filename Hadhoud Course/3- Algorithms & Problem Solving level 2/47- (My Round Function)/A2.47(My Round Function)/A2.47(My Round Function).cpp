...
{
	return (long long)(Number * 10) % 10 >= 5 ? ++Number : Number;
}
...
int main()
{
	...
	while (1) {
		...
		cout << "*******************************************************" << endl << endl;
		cout << "My Round Function Result (Hadhoud): { " << MyRound(Number) << " }" << endl << endl;
		cout << "C++ Round Function Result: { " << round(Number) << " }" << endl << endl;
		cout << "*******************************************************" << endl << endl;
