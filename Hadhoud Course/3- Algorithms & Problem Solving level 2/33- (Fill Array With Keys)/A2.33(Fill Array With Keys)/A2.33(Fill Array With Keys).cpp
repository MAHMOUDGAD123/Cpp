...
void Print_IntArray(short Array[100], short Arr_Length)
{
...
string _Generate_Random_Word_With_Length(en_CharType CharType, short Length)
{
	string Word;
...
string CapChars_Digits_Key_Generator_Of_N_Words(short NumberOfWords)
{
	...
	for (short i = 1; i <= NumberOfWords; i++)
	{
		Key += CapChars_Digits_Word_Generator_With_Length(5);
...
void Fill_Array_With_CapCharsKeys(string Array[], short Arr_Length)
{
	for (short i = 0; i < Arr_Length; i++)
	{
		Array[i] = Key_Generator_Of_N_Words(5);
	}
}

void Fill_Array_With_CapCharsDigitsKeys(string Array[], short Arr_Length)
{
	for (short i = 0; i < Arr_Length; i++)
	{
		Array[i] = CapChars_Digits_Key_Generator_Of_N_Words(5);
	}
}
...
int main()
{
	...
	short Arr_Length = 0;
	Arr_Length = Read_Positive_LLInt_NumberInRange("How Many Keys Do You Want To Generate?", 1, 100);

	cout << "# Array 1 Of Capital Letter Keys/\n";
	cout << "__________________________________" << endl << endl;
	Fill_Array_With_CapCharsKeys(Array1, Arr_Length);
	Print_StringArray(Array1, Arr_Length);

	cout << "\n****************************************************************" << endl << endl;
	cout << "# Array 2 Of Capital Letter & Digits Keys/\n";
	cout << "___________________________________________" << endl << endl;
	Fill_Array_With_CapCharsDigitsKeys(Array2, Arr_Length);
	Print_StringArray(Array2, Arr_Length);
