...
unsigned int Read_Positive_Int_Number_With_SpecificNumberOfDigits(string Message, int NumberOfDigits)
{
	string N;
...
void Print_String_In_A_Reversed_Order(string S)
{
...
int main()
{
	// MG
	cout << "\t\tMG Soulution\n\n";
	Print_String_In_A_Reversed_Order(Read_String_Positive_Int_Number("Please, enter only a positive integer number?"));

	cout << "--------------------------------------------------\n";
	cout << "--------------------------------------------------\n\n";

	// Abu_Hadhoud
	cout << "\tAbu-Hadhoud Soulution\n\n";
	Print_Digits_Reversed(Read_Positive_Int_Number("Please, enter a positive integer number?"));
