...
void _Fill_Array_With_Random_Numbers_From1toN_RefLength(short Array[], short& Arr_Length)
{
	Arr_Length = Read_Positive_Int_NumberInRange(1, 100);
...
int main()
{
	...
	Fill_Array_SimiDynamic_ByUserInput(Array, Arr_Length);
	//Fill_Array_With_Random_Numbers_From1toN_RefLength(Array, Arr_Length);
	...
	if (IsArrayPalindrome_MG(Array, Arr_Length))
	{
		cout << "-> The Array Is Palindrome :-)" << endl;
	}
	else
	{
		cout << "-> The Array Isn't Palindrome :-(" << endl;
