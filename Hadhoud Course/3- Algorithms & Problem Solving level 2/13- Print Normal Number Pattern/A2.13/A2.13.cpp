...
//****************************************************************************************************************
//****************************************************************************************************************
// Print Normal Number Pattern


void Print_Normal_Pattern(short Number)
{
...
int main()
{
	short Number = Read_Positive_LLInt_Number("Please, Enter A Positive Integer number?");
	Print_Normal_Pattern(Number);
