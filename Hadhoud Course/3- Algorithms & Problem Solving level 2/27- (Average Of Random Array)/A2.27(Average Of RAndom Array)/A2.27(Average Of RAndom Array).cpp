...
void _Fill_Array_With_Random_Numbers(short Array[100], short& Arr_Length)
{
	Arr_Length = Read_Positive_LLInt_NumberInRange("Please, Enter The Array Length?", 1, 100);
...
void _Print_Array(short Array[100], short Arr_Length)
{
	cout << "-> The Array is : { ";
	for (short i = 0; i < Arr_Length; i++)
	{
...
int _Get_Sum_Of_Array(short Array[100], short Arr_Length)
{
	int sum = 0;
...
int main()
{
	...
	cout << "-> The Sum Of The Array Elements = " << _Get_Sum_Of_Array(Array, Arr_Length) << endl << endl;
	cout << "-> The Average Of The Array Elements = " << Get_Average_Of_Array(Array, Arr_Length) << endl;
