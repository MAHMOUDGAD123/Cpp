...
//****************************************************************************************************************
//****************************************************************************************************************
// Read A Number & See The Repeating Times Of A specific Digit In This Number  


unsigned short Count_Frequncy_Of_N(unsigned long long Number, short Digit)
{
	unsigned short FreqCounter = 0;
	short Remainder = 0;
...
int main()
{
	...
	short Digit = Read_Positive_Int_Number("Please, The Digit To See How Many Times it Repeated in { " + to_string(Number) + " }");

	cout << "\n______________________________________________________________\n";
	cout << "______________________________________________________________\n\n";
	cout << "=> The Digit { " << Digit << " } Frequency is " << Count_Frequncy_Of_N(Number, Digit) << " Time(s)" << endl << endl;
