...
int main()
{
	...
	short Source_Array[100], CopyPrime_Array[100];
	short Source_Length = 0, CopyPrime_Length = 0;
	...
	CopyArray_PrimeNumbersBy_AddElementToArray(Source_Array, CopyPrime_Array, Source_Length, CopyPrime_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Copy Array Of Prime Numbers: {  ";
	Print_Array(CopyPrime_Array, CopyPrime_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;
