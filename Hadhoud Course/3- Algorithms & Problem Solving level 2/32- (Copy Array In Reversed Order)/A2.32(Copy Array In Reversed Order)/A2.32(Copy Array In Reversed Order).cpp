...
void Fill_Array_With_Random_Numbers_Length(short Array[], short& Arr_Length)
{
...
void Fill_Array_With_Random_Numbers(short Array[], short Arr_Length)
{
	for (short i = 0; i < Arr_Length; i++)
	{
		Array[i] = Generate_Random_Number_InRange(1, 100);
...
{
	short N = Read_Positive_LLInt_Number("Enter The Range Of Array Element?");
...
void Fill_Array_With_Random_Numbers_From1toN_WithoutRepeating(short Array[], short Arr_Length)
{
	short X = 0;
	short N = Read_Positive_LLInt_Number("Enter The Range Of Array Element?");
...
//*******************************************************************************************************************************************************
//*******************************************************************************************************************************************************
// Copy Array In A Reversed Order

int _Generate_Random_Number_InRange(int From, int To)
{
	//Function To Generate A Random Number In Range Of (From -> To)
...
void _Fill_Array_With_Random_Numbers_From1toN_WithoutRepeating(short Array[], short Arr_Length)
{
	short X = 0;
	short N = Read_Positive_LLInt_Number("Enter The Range Of Array Element?");
...
void _Take_Copy_Of_Array(short Source_Array[], short Copy_Array[], short Arr_Length)
{
	// You Should Declare The Copy_Array In The Main Function First & Then Racall This Function 
...
void _Swap2Numbers(short& N1, short& N2)
{
	short temp = 0;
	temp = N1;
	N1 = N2;
...
int main()
{
	...
	short Array[100], Reversed_Copy[100], Arr_Length;

	Arr_Length = Read_Positive_LLInt_Number("Please, Enter The Number Of The Array Elements?");

	_Fill_Array_With_Random_Numbers_From1toN_WithoutRepeating(Array, Arr_Length);


	//MG
	//CopyArray_InReverdedOrder_MG(Array, Reversed_Copy, Arr_Length);

	//Hadhoud
	CopyArray_InReverdedOrder_Hadhoud(Array, Reversed_Copy, Arr_Length);
	...
	cout << "-> The Reversed Copy Array  : { ";
	_Print_Array(Reversed_Copy, Arr_Length);
	cout << "}" << endl << endl;
