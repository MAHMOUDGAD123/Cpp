...
//****************************************************************************************************************
//****************************************************************************************************************
// Inverted Letters Puttern


//  My Solutions

//  (1)
void Print_Inverted_Letters_Pattern_MG1(short Number)
{
...
//  (2)
void Print_Inverted_Letters_Pattern_MG2(short Number)
{
	for (short i = 65 + Number - 1; i >= 65; i--)
	{
		for (short j = 0; j <= i - 65; j++)
		{
			cout << char(i) << " ";
		}
		cout << endl;
...
void Print_Inverted_Letters_Pattern_HadHoud(short Number)
{
	for (short i = 65 + Number - 1; i >= 65; i--)
	{
...
int main()
{
	Print_Inverted_Letters_Pattern_MG1(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?"));

	Print_Inverted_Letters_Pattern_MG2(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?"));



	Print_Inverted_Letters_Pattern_HadHoud(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?"));
