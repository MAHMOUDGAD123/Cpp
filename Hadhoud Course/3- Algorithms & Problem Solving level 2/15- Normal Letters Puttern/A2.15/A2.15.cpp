...
//****************************************************************************************************************
//****************************************************************************************************************
// Normal Letters Puttern


//  My Solution
void Print_Letters_Pattern_MG(short Number)
{
...
void Print_Letters_Pattern_HadHoud(short Number)
{
	for (short i = 65; i <= 65 + Number - 1; i++)
	{
...
int main()
{
	//Print_Letters_Pattern_MG(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?"));

	Print_Letters_Pattern_HadHoud(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?"));
