...
unsigned long long Read_Positive_Int_Number(string Message)
{
	string N;
...
unsigned long long Read_Positive_Int_Number_With_SpecificNumberOfDigits(string Message, int NumberOfDigits)
{
	string N;
...
unsigned long long Read_Positive_Int_NumberInRange(int from, int to)
{
	string N;
	do
	{
...
unsigned long long Read_Positive_Int_NumberInRange_Message(string Message, int from, int to)
{
	string N;
	do
	{
...
//Solution 1
int Reversed_Number(long long Number)
{
...
// Solution 2
int Reversed_String_Number(unsigned long long Number)
{
	string Reversed = "";
	short Remainder = 0;
...
int main()
{
	/*cout << "The Reversed Number Is : "
		<< Reversed_Number(Read_Positive_Int_Number("Please, Enter A Positive Integer Number?"))
		<< endl << endl;*/

	cout << "The Reversed Number Is : "
		<< Reversed_String_Number(Read_Positive_Int_Number("Please, Enter A Positive Integer Number?"))
		<< endl << endl;
