...
//*******************************************************************************************************************************************************
//*******************************************************************************************************************************************************
// Array Of Sum Of 2 Arrays Elements
...
int main()
{
	...
	short Array1[100], Array2[100], Arr12Sum[100], Arr_Length;

	Arr_Length = Read_Positive_LLInt_NumberInRange("Please, Enter The Array Length?", 1, 100);

	_Fill_Array_With_Random_Numbers(Array1, Arr_Length);
	_Fill_Array_With_Random_Numbers(Array2, Arr_Length);

	Fill_Array_With_Sum_Of_2Arrays_Elements(Array1, Array2, Arr12Sum, Arr_Length);


	cout << "-> Array 1 : { ";
	_Print_Array(Array1, Arr_Length);
	cout << "}" << endl << endl;

	cout << "-> Array 2 : { ";
	_Print_Array(Array2, Arr_Length);
	cout << "}" << endl << endl;

	cout << "-> Arr1 & Arr2 Sum : { ";
	_Print_Array(Arr12Sum, Arr_Length);
	cout << "}" << endl << endl;
