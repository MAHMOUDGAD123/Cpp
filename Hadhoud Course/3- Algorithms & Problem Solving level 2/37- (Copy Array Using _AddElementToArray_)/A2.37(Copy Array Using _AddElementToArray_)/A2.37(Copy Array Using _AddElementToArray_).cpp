...
void Take_Copy_Of_Array_V1(short Source_Array[], short Copy_Array[], short Arr_Length)
{
...
//*******************************************************************************************************************************************************
//*******************************************************************************************************************************************************
// Copy Array Using _AddElementToArray_ Function (From Problem 2.28)
...
void CopyArrayBy_AddArrayElement(short Source_Array[], short Copy_Array[], short Source_Length, short& Copy_Length)
{
	// You Should Declare The Copy_Array In The Main Function First & Then Racall This Function 
...
int main()
{
	...
	short Source_Array[100], Copy_Array[100], Source_Length = 0, Copy_Length = 0;
	...
	CopyArrayBy_AddArrayElement(Source_Array, Copy_Array, Source_Length, Copy_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Copy Array Elements: {  ";
	Print_Array(Copy_Array, Copy_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;
