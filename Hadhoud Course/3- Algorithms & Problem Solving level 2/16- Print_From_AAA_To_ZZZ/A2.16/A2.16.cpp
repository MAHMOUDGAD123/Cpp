...
//****************************************************************************************************************
//****************************************************************************************************************
// Print From AAA -> AAB -> AAC -> ....... -> ZZZ


//  My Solution
void Print_From_AAA_To_ZZZ_MG()
{
...
void Print_From_AAA_To_ZZZ_HadHoud()
{
	string Word = "";
...
int main()
{
	Print_From_AAA_To_ZZZ_MG();

	//Print_From_AAA_To_ZZZ_HadHoud();
