...
void _Fill_Array_SimiDynamic_ByUserInput(short Array[], short& Arr_Length)
{
	bool AddMore;
	short C = 0;
	Arr_Length = 0;
...
int main()
{
	...
	short Source_Array[100], CopyDistinct_Array[100];
	short Source_Length = 0, CopyDistinct_Length = 0;

	Fill_Array_SimiDynamic_ByUserInput(Source_Array, Source_Length);
	...
	CopyArray_DistinctNumbersBy_AddElementToArray(Source_Array, CopyDistinct_Array, Source_Length, CopyDistinct_Length);

	cout << "****************************************************************************************************" << endl << endl;
	cout << "Copy Array Of Prime Numbers: {  ";
	Print_Array(CopyDistinct_Array, CopyDistinct_Length);
	cout << "}" << endl << endl;
	cout << "****************************************************************************************************" << endl;
