...
int main()
{
	...
	short Array[100], Arr_Length, NumberToCheck;

	Read_Array(Array, Arr_Length);

	NumberToCheck = Read_Positive_LLInt_Number("Enter The Number You Want To Check?");

	Print_Array(Array, Arr_Length);

	cout << "-> Number (" << NumberToCheck << ") Frequency is = " << Get_Number_Frequency_InArray(Array, NumberToCheck, Arr_Length);
	cout << endl << endl;
