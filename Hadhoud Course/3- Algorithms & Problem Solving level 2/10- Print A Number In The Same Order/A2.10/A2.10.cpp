...
//****************************************************************************************************************
//****************************************************************************************************************
// Print A Number In The Same Order 

// Solution 1 (MG Solution)
unsigned long long Reverse_String(string N)
{
	string Reversed_N = "";
...
int main()
{
	...
	// Solution 1
	//Print_Number_Reversed(Read_Positive_LLInt_Number_Reversed("Please, Enter A Positve Integer Number?"));


	// Solution 2
	//Print_Number_Digits_Reversed(Reverse_Number(Read_Positive_LLInt_Number("Please, Enter A Positive Integer Number?")));


	// Solution 3
	Print_Number_Digits_As_String(Read_Positive_LLInt_Number("PLease, Enter A Positive Integer Number?"));
