...
void Print_CheckResult_MG(short Array[], short Arr_Length, short NumberToCheck)
{
	cout << "The Number That You Are Searching For Is : (" << NumberToCheck << ")" << endl << endl;

	bool Result = IsNumber_InArray_MG(Array, Arr_Length, NumberToCheck);

	if (Result)
		cout << "Yeah, We Found Your Number :-)" << endl;
	else
		cout << "Sorry, We Didn't Find Your Number :-(" << endl;
}


// Hadhoud 
short _GetNumberIndex_InArray_NR(short Array[], short Arr_Length, short NumberToCheck)
{
	// Only return the number index in the array if there is no repeating in the array
...
bool IsNumber_InArray_Hadhoud(short Array[], short Arr_Length, short NumberToCheck)
{
	...
	return GetNumberIndex_InArray_NR(Array, Arr_Length, NumberToCheck) != -1;
}

void Print_CheckResult_Hadhoud(short Array[], short Arr_Length, short NumberToCheck)
{
	cout << "The Number That You Are Searching For Is : (" << NumberToCheck << ")" << endl << endl;

	bool Result = IsNumber_InArray_Hadhoud(Array, Arr_Length, NumberToCheck);
...
int main()
{
	...
	Fill_Array_With_Random_Numbers_From1toN(Array, Arr_Length);

	cout << "Array Elements: { ";
	Print_IntArray(Array, Arr_Length);
	cout << "}" << endl << endl;
	...
	// MG
	//Print_CheckResult_MG(Array, Arr_Length, NumberToCheck);


	// Hadhoud
	Print_CheckResult_Hadhoud(Array, Arr_Length, NumberToCheck);
