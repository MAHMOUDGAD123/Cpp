...
bool AreEqualMatrices(int Matrix1[10][10], int Matrix2[10][10], const unsigned short* Rows, const unsigned short* Columns)
{
...
int main()
{
	...
	if (AreEqualMatrices(Matrix1, Matrix2, &Rows, &Columns))
	{
		cout << "\n-> The 2 Matrices Are Equal :-)\n\n";
	}
	else
	{
		cout << "\n-> The 2 Matrices Aren't Equal :-)\n\n";
	}
