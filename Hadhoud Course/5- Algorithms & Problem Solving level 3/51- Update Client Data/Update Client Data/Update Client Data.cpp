...
void UpdateClientDataByAccountNumber(string AccountNumber, vector <sClient>& vClients)
{
	sClient Client;
...
void FindAndUpdateClientData()
{
	vector <sClient> vClients = LoadClientsDataFromFile(ClientsFileName);
	string AccountNumber = ReadTxt("\n\n-> Please, Enter The Acount Number: ");
