...
long long DiffInDays(sDate StartDate, sDate EndDate, bool includeEndDay = false)
{
...
long long AgeInDays(sDate DateOfBirth)
{
...
int main(void)
{
	...
	for (;;)
	{
		...
		printf("-> Difference Is:                          %lld Day(s)\n", DiffInDays(Date1, Date2));
		printf("-> Difference (Including The End Day) Is:  %lld Day(s)\n\n", DiffInDays(Date1, Date2, true));
