...
unsigned short DateToDayOrderInYear(sDate Date)
{
	...
	for (unsigned short MonthOrder = 1; MonthOrder <= Date.Month - 1; MonthOrder++)
		TotalDays += NumberOfDaysInMonth(Date.Year, MonthOrder);
...
int main(void)
{
	...
	for (;;)
	{
		...
		printf("\n-> Date2 Is:  %2hu/%2hu/%llu", Date2.Day, Date2.Month, Date2.Year);


		if (IsDate1BeforeDate2(Date1, Date2))
		{
			printf("\n-------------------------------\n");
			printf("Yes, Date1 is less than Date2");
			printf("\n-------------------------------\n");
		}
		else
		{
			printf("\n-------------------------------\n");
			printf("No, Date1 isn't less than Date2");
			printf("\n-------------------------------\n");
		}
