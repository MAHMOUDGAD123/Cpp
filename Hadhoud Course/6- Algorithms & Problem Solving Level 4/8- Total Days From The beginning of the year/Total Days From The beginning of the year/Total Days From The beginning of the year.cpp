...
short DayOrderInAYear(unsigned short year, unsigned short month, unsigned short day)
{
	unsigned short TotalDays = 0;

	for (short MonthOrder = 1; MonthOrder <= month - 1; MonthOrder++)
